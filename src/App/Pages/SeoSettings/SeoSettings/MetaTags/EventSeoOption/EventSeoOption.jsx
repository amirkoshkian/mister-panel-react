...
////////////////////////////////////////////////////////////////////////////////////////////////////// Start Section Class
export default class EventSeoOption extends React.Component {
  render() {
    return (
            ...
            <section className="col-xl-12 p-2">
              <section className="bg-t-o b-r-10">
                <section className="d-flex align-items-center justify-content-between p-3">
                  <span>تمام جزئیات سئوی رویدادها</span>
                </section>
                ...
                <section className="p-2 table-users-page-seo-settings">
                  <table>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>4</td>
                        <td>مکان هایی برای گذراندن وقت</td>
                        <td className="progress">
                          <section
                            aria-valuemax="100"
                            aria-valuemin="0"
