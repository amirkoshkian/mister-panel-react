...
////////////////////////////////////////////////////////////////////////////////////////////////////// Start Section Class
export default class FeatureEvents extends React.Component {
  render() {
    return (
            ...
            <section className="col-xl-12 p-2">
              <section className="bg-t-o b-r-10">
                <section className="d-flex align-items-center justify-content-between p-3">
                  <span>جزئیات رویداد را مشخص کنید</span>
                </section>
              </section>
            </section>
                  ...
                  <table>
                    ...
                    <tbody>
                      <tr>
                        <td>1</td>
                        <td>
                          <span>مسیرهای دوچرخه سواری</span>
                        </td>
                        <td>
